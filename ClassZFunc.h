...
ClassZ::ClassZ(string newID, string newPassword, string newFname, string newLname, string newPhoneNum, double newInterestRate) : BankAcc("Z", newID, newPassword, newFname, newLname, newPhoneNum, newInterestRate, 0.0)
{
    ID = newID.insert(0, "Z");  //insert a C at the start of the acc number
}
