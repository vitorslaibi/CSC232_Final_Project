/*
- This file contains ClassZ class, a subclass of BankAcc, used to store checking accounts's data
...
public:
    static bool active;
    static int totalZ;
    ClassZ(string newID, string newPassword, string newFname, string newLname, string newPhoneNum);
