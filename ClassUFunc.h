...
ClassU::ClassU(string newID, string newPassword, string newFname, string newLname, string newPhoneNum, double newInterestRate) : BankAcc("U", newID, newPassword, newFname, newLname, newPhoneNum, newInterestRate, 0.0)
{
