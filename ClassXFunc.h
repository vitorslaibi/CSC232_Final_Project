/*
- This file contains definitions of ClassX class's functions
*/
...
ClassX::ClassX(string newID, string newPassword = "", string newFname = "", string newLname = "", string newPhoneNum = "", double newInterestRate = 0.0) : BankAcc(newID, newPassword, newFname, newLname, newPhoneNum, newInterestRate, 0.0)
{
